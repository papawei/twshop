...
public class DruidDataSourceConfig implements EnvironmentAware {
	...
	public ServletRegistrationBean druidServlet() {
		...
		servletRegistrationBean.setServlet(new com.alibaba.druid.support.http.StatViewServlet());
	...
	public FilterRegistrationBean filterRegistrationBean() {
		...
		filterRegistrationBean.setFilter(new com.alibaba.druid.support.http.WebStatFilter());
