...
import com.tw.captcha.CaptchaConfigBean;
import com.tw.config.StaticConfigSupplier;
...
public class SecurityWebApplicationInitializer extends AbstractSecurityWebApplicationInitializer {
	...
	protected void beforeSpringSecurityFilterChain(ServletContext servletContext) {
		...
		Dynamic encodingRegistration = servletContext.addFilter("CharacterEncodingFilter",
				new CharacterEncodingFilter(com.tw.common.util.Constants.characterEncoding, true));
